...
public class CreateWordXDDFChart2 {
    ...
    public static void main(String[] args) throws Exception {
        try (XWPFDocument document = new XWPFDocument()) {
            ...
            try (FileOutputStream fileOut = new FileOutputStream("/Users/sunzg/Documents/File/Java/boot/springboot-other/study-poi/src/main/resources/CreateWordXDDFChart2.docx")) {
