...
//        ClientAnchor anchor = drawing.createAnchor(0, 0, 0, 0, 4, 0, 11, 15);
        ...
        FileOutputStream fileOut = new FileOutputStream("/Users/sunzg/Documents/File/Java/boot/springboot-other/study-poi/src/main/resources/BarAndLineChart2.xlsx");
        wb.write(fileOut);
        fileOut.close();
    }
}
